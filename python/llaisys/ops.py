...
class Ops:
    ...
    @staticmethod
    def linear(out: Tensor, inp: Tensor, weight: Tensor, bias: Tensor, scales: Tensor = None):
        LIB_LLAISYS.llaisysLinear(
            out.lib_tensor(), inp.lib_tensor(), weight.lib_tensor(), bias.lib_tensor(), scales.lib_tensor() if scales else None
        )
